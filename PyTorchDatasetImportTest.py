...
#
# .. note::
#     Download the dataset from `here <https://download.pytorch.org/tutorial/joints.zip>`_
#     so that the images are in a directory named 'joints/'.
...
landmarks_frame = pd.read_csv('jointsTrain.csv')
...
plt.figure()
show_landmarks(io.imread(os.path.join('joints/', img_name+'.jpg')),
               landmarks)
plt.show()
...
face_dataset = FaceLandmarksDataset(csv_file='jointsTrain.csv',
                                    root_dir='joints/')
...
transformed_dataset = FaceLandmarksDataset(csv_file='jointsTrain.csv',
                                           root_dir='joints/',
