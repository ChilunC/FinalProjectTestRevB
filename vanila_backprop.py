...
if __name__ == '__main__':
    ...
    for target_example in range(1):
        ...
        save_gradient_images(vanilla_grads, file_name_to_export + '_Vanilla_BP_color'+str(target_example))
        # Convert to grayscale
        grayscale_vanilla_grads = convert_to_grayscale(vanilla_grads)
        # Save grayscale gradients
        save_gradient_images(grayscale_vanilla_grads, file_name_to_export + '_Vanilla_BP_gray'+str(target_example))
